...
namespace OpenIdProvider.Controllers
{
    ...
    {
        internal static DotNetOpenAuth.OpenId.Provider.OpenIdProvider OpenIdProvider = new DotNetOpenAuth.OpenId.Provider.OpenIdProvider();
        ...
        /// <summary>
        /// Confirm the user's login without requesting specific properties
        /// </summary>
        /// <returns></returns>
        [Authorize]
        public ActionResult SilentConfirm()
        {
